...
export default function DeleteModal({ activeComment, setActiveComment }) {
    ...
    return (
        <Rodal visible={activeComment && true} onClose={onClose}>
            <div className="h-100 d-flex align-items-center py-2 px-4">
                <div className="text-center">
                    <h2>¿Estás seguro de eliminar el comentario?</h2>
