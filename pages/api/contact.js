...
const TESTING_EMAIL = "desarrollo@click2luck.com";
const TESTING_LOGO = "http://localhost:3000/img/logo.png";
  ...
  transporter.verify(function(error, success) {
    if (!error) {
      const mailData = {
        from: TESTING_EMAIL,
        to: body.email,
        repplyTo: TESTING_EMAIL,
        subject: "¡Correo recibido! - Macroconcesionario",
        attachments: [
          {
            filename: "logo.png",
            path: /* imgPath + "logo.png" */ TESTING_LOGO,
            cid: "logo",
          },
          {
        ...
        const mailData = {
          ...
          attachments: [
            ...
            },
            {
              ...
              path:
                body.imageFormatted ||
                imgPath + "coches-electricos-online.webp",
              cid: "img",
            },
          ],
